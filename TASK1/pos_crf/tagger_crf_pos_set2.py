...
def creatdict(sentence,index,pos):	#pos=="" <-> featuresofword  else, relative pos (str) is pos
	...
	wordapos = any(p in wordlow for p in "'")
	wordlength = len(wordlow);
	dict={
		"word"+pos:wordlow,
		"contains_punctuation"+pos:wordpunct,
		"word_length"+pos:wordlength,
		"end_with_ing"+pos:wordlow.endswith("ing"),
		"contains_apostrophe"+pos:wordapos,
		"last_3"+pos:wordlow[-3:],
		"stemmed"+pos:re.sub(r'(.{2,}?)([aeiougyn]+$)',r'\1', wordlow),
		"is_digit"+pos:wordlow.isdigit()
	}
	return dict
...
if __name__ == "__main__":
	...
	classifier=sklearn_crfsuite.CRF(c1=0.2, c2=0.2, max_iterations=2000)
